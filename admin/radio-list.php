          ...
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
               ...
               <div class="form-group">
                 <input type="text" class="form-control" id="radoname" name="radoname" placeholder=" Radio Name! ">
                </div>
                <div class="form-group">
                  <select class="form-control selectedStyle" name="radiocat">
                    <option value="" style="display: none" selected hidden>Select Radio Category</option>
               ...
               <div class="form-group">
                 <input type="text" class="form-control" id="radio_city" name="radio_city" placeholder="City and Country Name!">
                </div>
                <div class="form-group">
                 <input type="text" class="form-control" id="stream_url" name="stream_url" placeholder="Radio Stream URL!">
                </div>
                <div class="form-group">
                 <input type="text" class="form-control" id="radio_url" name="radio_url" placeholder="Website URL!">
                </div>
                <div class="form-group">
            ...
            <div class="tab-content">
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <tr>
                  ...
                  <td><a target="_blank" href="<?php echo $rows['radio_url']; ?>"><img src="../<?php echo $rows['radio_img']; ?>" width='100' height='auto'></a></td>
